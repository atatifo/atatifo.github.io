      ...
      t.default = function (e) {
        ...
        if (
          ...
          if (
            ...
            (G = q.src),
            (!D || 'fill' !== D) &&
              ((z = z || q.height), (k = k || q.width), !q.height || !q.width))
          )
            throw new Error(
        ...
        r = 'string' === typeof r ? r : G;
        var U = A(k),
          H = A(z),
          B = A(j),
          Z = !d && ('lazy' === p || 'undefined' === typeof p);
        (r.startsWith('data:') || r.startsWith('blob:')) &&
          ((l = !0), (Z = !1));
        (null === (t = W.current) || void 0 === t ? void 0 : t.complete) &&
          (Z = !1);
        0;
        var $,
          F = i(
            f.useIntersection({ rootRef: v, rootMargin: w, disabled: !Z }),
            2
          ),
          K = F[0],
          V = F[1],
        ...
        var oe = { src: m, srcSet: void 0, sizes: void 0 };
        J &&
          (oe = O({
            src: r,
            unoptimized: l,
                      ...
                      .then(function () {
                        if (
                          ...
                          var r = t.naturalWidth,
                            i = t.naturalHeight;
                          o.current({ naturalWidth: r, naturalHeight: i });
                        }
                      });
                };
                e.current &&
      ...
      var h = new Map([
        ...
        [
          ...
          function (e) {
            ...
            return ''.concat(t).concat(i).concat(z(r));
          },
        ],
        [
          'akamai',
          function (e) {
            var t = e.root,
              r = e.src,
              n = e.width;
            return ''.concat(t).concat(z(r), '?imwidth=').concat(n);
          },
        ],
        [
          'custom',
        ...
        return (0, n.jsx)('footer', {
          ...
          children: l.map(function (e) {
            var t = e.href,
              r = e.label;
            return (0,
            n.jsx)(a.Z, { href: t, className: 'text-white', children: (0, n.jsx)('div', { className: 'text-red', style: { color: 'red', fill: 'green' }, children: (0, n.jsx)(i.default, { src: '/icons/'.concat(r.toLowerCase(), '.svg'), alt: r, width: '35px', height: '35px', className: 'cursor-pointer hover:scale-105', unoptimized: !0 }) }) }, ''.concat(t).concat(r));
          }),
        });
      }
      var s = r(6010),
